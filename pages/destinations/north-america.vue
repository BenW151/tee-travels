<template>
  <div class="destination-pages">
    <Header
      imageUrl="/images/cabada-cover.png"
      imageAlt="TODO alt"
      title="North America"
    ...
    <BlogCountryPosts region="north-america" labelText="Blog Posts">
    ...
    <BlogRegionalDestinations region="north-america" labelText="Countries">
